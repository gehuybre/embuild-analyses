...
export const metadata: Metadata = {
  ...
  description: "Evolutie van de Belgische hypothecaire rente op nieuwe contracten met een initiële rentevaste periode van meer dan 10 jaar, op basis van de NBB MIR-statistiek sinds 2015.",
};
