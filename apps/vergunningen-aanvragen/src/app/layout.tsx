...
export const metadata: Metadata = {
  ...
  description: "Analyse van de aanvragen voor vergunningen voor het bouwen, verbouwen of slopen van woningen in Vlaanderen, op basis van data uit het Omgevingsloket.",
};
