...
export const metadata: Metadata = {
  ...
  description: "Evolutie van inschrijvingen in het hoger onderwijs naar type onderwijsinstelling, opleiding en studiegebied op basis van PinC-data (woonplaats).",
};
