...
export const metadata: Metadata = {
  ...
  description: "Analyse van de verdeling van energielabels (EPC) voor residentiële en niet-residentiële gebouwen in Vlaanderen. In welke mate voldoen onze gebouwen al aan de doelstelling van minstens label A?",
};
