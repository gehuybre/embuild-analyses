...
`.github/skills/blog-post-creator/scripts/validate_component_usage.py`.
...
SCRIPT = os.path.normpath(os.path.join(os.path.dirname(__file__), '..', '.github', 'skills', 'blog-post-creator', 'scripts', 'validate_component_usage.py'))
